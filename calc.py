...
label = ttk.Label()
label.grid(row=1, column=3, padx=10, pady=10, columnspan=2)
...
btnequals = ttk.Button(text="=", font=("Lucida Grange Regular", 20), command=show_message) # добавление функционала кнопки
